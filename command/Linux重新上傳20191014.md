...
```
解釋下列資訊的意義:
mtu 1500 (最大傳輸單元 Maximum Transmission Unit縮寫
inet 172.17.0.1  inet＝internet(網路
netmask 255.255.0.0  （子網路遮罩 
broadcast 172.17.255.255 (廣播
ether 02:42:a0:1e:82:96 （乙太網
```
```
問題1.IP位址==?  A:172.17.0.1
...
```
root@kali:/# ls
0     etc(等等  法語的et cetera             lib     lost+found  proc  srv  var
...
1
```
root@kali:/KSU1# python test1.py
hello!
89.4
abcdef
ant
...
root@kali:/KSU1# python test2.py
(1, '/', 2, '=', 0)
1/2=0
...
```
5
```root@kali:/KSU# python test5.py
Enter a number to find the square of: 45
Enter a integer to find the square of: 55
3025
